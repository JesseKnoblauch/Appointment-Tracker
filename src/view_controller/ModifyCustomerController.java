...
/**
 * Public class for ModifyCustomer Controller.
 */
public class ModifyCustomerController implements Initializable {
    ...
    void onActionBack(ActionEvent event) {
        try {
            ...
            stage.show();
        } catch (Exception e) {System.out.println("Exception when calling onActionBack in ModifyCustomerController: " + e.getMessage());}
    }
    ...
    /**
     * Updates customer in database using form fields.
     */
    private void updateCustomer() {
        try {
            ...
            DBQuery.setPreparedStatement(conn, "UPDATE customers SET Customer_Name = ?, Address = ?, Postal_Code = ?, Phone = ?, Division_ID = ? WHERE Customer_ID = ?");
            ...
            if(ps.executeUpdate() > 0) {
                ...
                Popups.informationalPopup("Customer " + name + " updated successfully", "Alert");
            }
        } catch (SQLException e) {System.out.println("Exception caught while calling saveAppointment in ModifyCustomerController: " + e.getMessage());}
    }
    ...
    private String getCountryId() {
        ...
        } catch(Exception e) {System.out.println("Exception caught while calling getCountryId in ModifyCustomerController" + e.getMessage());}
        return "";
    }
    ...
    private String getDivision() {
        ...
        } catch(Exception e) {System.out.println("Exception caught while calling getDivision in ModifyCustomerController" + e.getMessage());}
        return "";
    }
    ...
    private ObservableList<String> getStates(String country) {
        ...
        } catch(Exception e) {System.out.println("Exception caught while calling getStates in ModifyCustomerController" + e.getMessage());}
        return statesList;
    }
    ...
    /**
     * Method called while loading modifyCustomer. Fills customer fields with data from selectedCustomer selected on main menu.
     */
    public void setCustomerFields() throws SQLException {
        String country = selectedCustomer.getCountryName();
        String state = selectedCustomer.getStateName();
        customerState.setDisable(false);
        ...
        customerPostal.setText(selectedCustomer.getPostalCode());
        customerPhone.setText(selectedCustomer.getPhone());
    }

    /**
     * Sets selectedCustomer to customer selected on Scheduling view.
     * @param customer Customer object selected by user.
     */
